...
export default function HomePage() {
  return (
    <div className="relative isolate">
      ...
      {/* HERO centré */}
      <section className="grid min-h-[65vh] place-items-center py-16">
...
function Card({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    ...
    >
      <div className="text-base font-semibold mb-2">{/* title slot via first child <h3> */}</div>
      {/* reset margin of first h3 inside */}
